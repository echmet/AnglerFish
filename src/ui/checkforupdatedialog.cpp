  ...
  ui(new Ui::CheckForUpdateDialog)
{
  ...
  const bool autoUpdateEnabled = persistence::SWSettings::get<int>(persistence::SWSettings::KEY_AUTOUPDATE_ENABLED) > 0;
  ui->qcb_checkOnStartup->setChecked(autoUpdateEnabled);
}
